        ...
        <div>
            <div className='left_body'>
                ...
                <div class="manage-item">
                    ...
                    <a href='/adm_man_user'>
                        <div className={`admin-item ${localStorage.getItem('tag') === '1' ? 'manage-employee' : ''}` + " rounded"} onClick={() => { localStorage.setItem("tag", "1"); }}>
                            <FontAwesomeIcon icon={faUser} class="icon-1"></FontAwesomeIcon>
                            Customer Manager
                        </div>
                    </a>
                    <a href='/adm_man_product'>
                        <div className={`admin-item ${localStorage.getItem('tag') === '2' ? 'manage-employee' : ''}` + " rounded"} onClick={() => { localStorage.setItem("tag", "2"); }}>
                            <FontAwesomeIcon icon={faBars} class="icon-1"></FontAwesomeIcon>
                            Product Manager
                        </div>
                    </a>
                    <a href='/adm_man_order'>
                        <div className={`admin-item ${localStorage.getItem('tag') === '3' ? 'manage-employee' : ''}` + " rounded"} onClick={() => { localStorage.setItem("tag", "3"); }}>
                            <FontAwesomeIcon icon={faBagShopping} class="icon-1"></FontAwesomeIcon>
                            Order Manager
                        </div>
                    </a>
                    <a href='/adm_man_emp'>
                        <div className={`admin-item ${localStorage.getItem('tag') === '5' ? 'manage-employee' : ''}` + " rounded"} onClick={() => { localStorage.setItem("tag", "5"); }}>
