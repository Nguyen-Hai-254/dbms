...
class PrePaymentB extends Component {
  render() {
    return (
                ...
                <div class="container">
                    ...
                    <div class="row mt-2 justify-content-around ">
                        ...
                        <div class="col-6 bg-white px-4">
                            ...
                            <div class="mt-5 fs-6">Card information</div>
                            <div class="row mt-2">
                                <div class="col-9">
                                    <input class="p-1 rounded w-100"type="text" placeholder='Card number'/>
                                </div>
                                <div class="col-3">
                                    <input class="p-1 rounded w-100"type="text" placeholder='cvv'/>
                                </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-9">
                                    <input class="p-1 rounded w-100"type="text" placeholder='Name on card'/>
                                </div>
                                <div class="col-3">
                                    <input class="p-1 rounded w-100"type="text" placeholder='mm/yy'/>
                                </div>
